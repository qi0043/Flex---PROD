 ...
 */
class Showsam_New extends CI_Controller 
{
    ...
    public function index($format='html', $uuid='missed', $version='missed')
    {
        ...
        */
        ...
        if($format=='html')
        {
            ...
            $this->load->view('sam/showsam_view_new', $data);
        }
        else if($format=='pdf')
        {
    ...
    { 
        ...
        $topicUnits = '/xml/item/curriculum/topics/topic/units';
        $topicSchool = '/xml/item/curriculum/topics/topic/school';
        $work_load = '/xml/item/curriculum/topics/topic/workload';
        ...
        #$samsArray['metadata']['topicLocation'] = $itemXml->nodeValue($topicLocation);
