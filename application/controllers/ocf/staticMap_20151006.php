	...
	private function generateHtml($topic, $courseCode)
	{
		...
		{	
			...
			if(isset($topic['numLinkedActivities']) && isset($topic['linked_activities'])) 
			{
				...
				{
					$html .= "<span class='topic_span'> <i class='fa fa-plus-circle activity'></i> " . $topic['code'] . "-" . $topic['title'] . "</span> &nbsp; &nbsp; <i style='cursor: pointer;' class='refresh_icon glyphicon glyphicon-refresh' id='rf_".$topic['code']."_".$courseCode."' title='refresh'></i>";
					$html .= "<ul id='ul_".$topic['code']."_".$courseCode."'>";
		...
		if($index > 1)
		{
		 ...
		 if ($activityType == 'activity') { 
			switch($do_condition)
			{
				...
				break;
				case 'optional': 
					$str .= '<li class="child_li"><i style="line-height:1em; vertical-align:middle" class="fa fa-circle-o fa-fw text-primary" title="optional activity"></i>&nbsp;&nbsp; <a href="/flex/ocf/activity/'.$itemUuid .'/'.$itemVersion.'/'.$parent_uuid .'" data-toggle="modal" data-target="#myModal" title="View activity detail">'. $activityName.'</a></li>';
			   break; 
			   case 'alternative': 
					$str .= '<li class="child_li"><!--<i style="line-height:1em; vertical-align:middle" ></i>&nbsp;&nbsp;--><a href="/flex/ocf/activity/'. $itemUuid.'/'.$itemVersion.'/'.$parent_uuid.'/" data-toggle="modal" data-target="#myModal" title="View activity detail">'.$activityName.'</a> </li>';
			  break; 
			}
		 ...
		 elseif($activityType == 'group')
		 {
			switch($do_condition)
			{
				case 'required':
					...
					if($group_how_many >= 1)
					{
						$str .= '<li class="parent_li"><span><i class="fa fa-plus-circle"></i> '. $activityName.'&nbsp;&nbsp;<i class="badge">pick&nbsp;'.$group_how_many.'&nbsp;of&hellip;</i></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/'.$itemUuid.'/'.$itemVersion.'/'.$topicCode.'" data-toggle="modal" data-target="#myModal"><i>detail</i></a>';
					}
				break;
				case 'optional':
					if($group_how_many == 0)
					{
						$str .= '<li class="parent_li"><span><i class="fa fa-plus-circle"></i> '. $activityName.' &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-circle-o fa-fw text-primary" title="optional activity"></i></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/'. $itemUuid.'/'. $itemVersion.'/'. $topicCode.'" data-toggle="modal" data-target="#myModal"><i>detail</i></a>';
					}
					
					if($group_how_many >= 1)
					{
						$str .= '<li class="parent_li"><span><i class="fa fa-plus-circle"></i> '.$activityName.'&nbsp;&nbsp; <i style="line-height:1em; vertical-align:middle" class="fa fa-circle-o fa-fw text-primary" title="optional activity"></i> &nbsp;&nbsp;<i class="badge">pick&nbsp;'.$group_how_many.'&nbsp;of&hellip;</i></span>&nbsp;&nbsp;<a href="/flex/ocf/lta/'. $itemUuid.'/'. $itemVersion.'/'. $topicCode.'" data-toggle="modal" data-target="#myModal"><i>detail</i></a>';
					}
					break;
				case 'alternative':
					if($group_how_many == 0)
					{
						$str .= '<li class="parent_li"><span><i class="fa fa-plus-circle"></i> '. $activityName.' &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" ></i></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/'. $itemUuid.'/'. $itemVersion.'/'. $topicCode.'" data-toggle="modal" data-target="#myModal"><i>detail</i></a>';
					}
