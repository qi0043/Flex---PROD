...
* @see http://codeigniter.com/user_guide/general/urls.html
	**/
	...
	public function index($uuid='missed', $version='missed', $tcode='missed', $activity_level='missed')
	{
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['overall']['instructions']['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['overall']['instructions']['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['overall']['instructions']['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['overall']['linked'][$l]['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['overall']['linked'][$l]['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['overall']['linked'][$l]['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['pre']['instructions']['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['pre']['instructions']['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['pre']['instructions']['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['pre']['linked'][$l]['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['pre']['linked'][$l]['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['pre']['linked'][$l]['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['during']['instructions']['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['during']['instructions']['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['during']['instructions']['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['during']['linked'][$l]['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['during']['linked'][$l]['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['during']['linked'][$l]['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['post']['instructions']['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['post']['instructions']['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['post']['instructions']['type'] = $typearesponse['attachments'][0]['type'];
...
// get infor for linked resources
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['post']['linked'][$l]['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['post']['linked'][$l]['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['post']['linked'][$l]['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['teachingTeam']['instructions']['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['teachingTeam']['instructions']['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['teachingTeam']['instructions']['type'] = $typearesponse['attachments'][0]['type'];
					...
					switch ($attachment['type']) {
						...
						case 'linked-resource':
							...
							if ($attachment['resourceType']	== 'a') {					
								...
								$item_array['teachingTeam']['linked'][$l]['description'] = $typearesponse['attachments'][0]['description'];
								$item_array['teachingTeam']['linked'][$l]['filename'] = $typearesponse['attachments'][0]['filename'];
								$item_array['teachingTeam']['linked'][$l]['type'] = $typearesponse['attachments'][0]['type'];
		...
		foreach ($item_array['activities'] as $linked) {
			...
			foreach ($response['attachments'] as $attachment) {
				...
				if ($linkedUUID == $attachmentUuid) {
					...
					$item_array['activities'][$i]['itemName'] = $this->attachmentXml2Name($this->$xmlwrapper_name_item);
		...
		*/
		...
		$item_array['ocf_groups_collection'] = $ocf_groups_collection;
		...
		*/
		...
		$data = array('item' => $item_array, 'activity_level' =>$activity_level,'token' => $this->generateToken($fan), 'upd_privilege' => $upd_privilege);
		...
		$this->load->view('ocf/lta3_item_AC', $data);
		
		//} else {		
		
		//$this->load->view('ocf/lta3_item', $data);
  ...
  /**
    ...
    { 
	 ...
	 protected function attachmentXml2Name($attachmentXml) 
    { 
		...
		//$tmp['activityTitle'] = $attachmentXml->nodeValue('/xml/item/itembody/name');
		//$tmp['activityDescription'] = $attachmentXml->nodeValue('/xml/item/itembody/description');
		$tmp = $attachmentXml->nodeValue('/xml/item/curriculum/activities/activity/name');
		//$tmp['itemUUID'] = $attachmentXml->nodeValue('/xml/item/@id');
		//$tmp['itemVersion'] = $attachmentXml->nodeValue('/xml/item/@version');
