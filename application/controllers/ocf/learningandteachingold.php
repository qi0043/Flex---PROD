...
class Learningandteachingold extends CI_Controller {
...
* @see http://codeigniter.com/user_guide/general/urls.html
	**/
	...
	public function index($uuid='missed', $version='missed', $tcode='missed')
	{
        ...
        {
            $errdata['message'] = "error in learning and teaching controller itemIsIntegrated: Item is not integrated";
            $this->load->view('ocf/showerror_view', $errdata);
            return;
        }
...
*/			
		...
		$this->load->view('ocf/lta_item', $data);
