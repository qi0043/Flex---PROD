...
class Rollover extends CI_Controller {
	...
	{
		echo "<br>This rollover tool has been obsoleted. Please use the eReadings list manager tool.";
		exit();
        ...
        public function rollover_activate()
	{
            ...
            */
            ...
            for($i=0;$i<$reading_count;$i++)
            {
                ...
                $activated = $this->rollover_model->db_chk_active_reading_for_avail($reading_link,$to_avail);
