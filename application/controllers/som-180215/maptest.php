	...
	*************************************************/
	public function getActivities()
	{
		 ...
		 {	 
			...
			{
				$returnData[$x] = $this->getActivityRecursiveCall($attachmentUuid,$uuid,$version,$topicCode,'',1,$key,$data,true);
				
			//$this->load->view('som/cmap_activities', $attachmentUuid, $uuid,$version,$topicCode); 
			}
			 else
			{
				echo 'not right';
		 ...
		 $this->load->view('som/cmap_activities', $data); 
