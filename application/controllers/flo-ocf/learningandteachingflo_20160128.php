...
class Learningandteachingflo extends CI_Controller {
...
// get infor for linked resources
		...
		*/
		...
		$data = array('item' => $item_array, 'token' => $this->generateToken($userUuid), 'privilege' => $user_role);
        ...
        */
		...
		$this->load->view('ocf/lta3_itemFLOac', $data);
