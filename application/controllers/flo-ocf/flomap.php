...
class floMap extends CI_Controller 
{
	 public function __construct()
     {
		...
		if(!isset($_SESSION['flo_ocf_role']) || !isset($_SESSION['flo_fan']))
		exit;
		...
		if($_SESSION['flo_ocf_role'] == 'Learner')
		{
			$user_role = 'learner';
		}
	 }
	 
	 public function render($courseCode)
	 {
		$errdata['heading'] = "Notice";
		...
		print_r($data);
		echo '</pre>';*/
		$this->load->view('ocf/flo/flomap_view', $data);	 
	 }
