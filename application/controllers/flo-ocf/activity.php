...
class Activity extends CI_Controller {
	...
	public function index($uuid='missed', $version='missed', $taa='missed')
	{
		...
		/*    ---------------  
		if($_SESSION['userinfo']['name'] === 'Anthony Couche') {
		echo "<pre>";
       ...
       // $collections = '6704afea-e88c-4230-b277-6d9d413bfbff';  // The Topic collection
		...
		foreach ($taaresponse['attachments'] as $relatedItem) {
		 ...
		 // $sysID = $item_array['sysUUID'];
			...
			$data = array('item' => $item_array, 'activity_los' => $activitylos_array, 'los' => $lo_array, 'token' => $this->generateToken($userUuid), 'upd_privilege' => $upd_privilege);
		...
		*/
		...
		$this->load->view('ocf/flo/activity_item', $data);
