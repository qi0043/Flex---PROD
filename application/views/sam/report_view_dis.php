...
<html lang="en">
	...
	<div id="main_content_wrap" class="outer">
        ...
        <div>
        	<h1>SAM Report by <?php echo $dis?></h1>
        </div>
        <section>
        ...
        <?php if($_SERVER['REMOTE_USER'] == 'qi0043'){?>
        
        <div>
        	<a id="export_csv">Click here to download</a>
        </div>
		<?php }?>
        <div id="table">
   	...
   	<script type="text/babel">
		...
		ReactDOM.render(
			<TableBox url="https://flextra.flinders.edu.au/flex/sam/report/getDis"/>
