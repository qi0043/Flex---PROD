...
.signature12 {
    ...
    <title>Statement of Assessment Methods</title>
</head>
<!-- <body id="bodytag"> -->
<body>
...
<!-- Content of SAM -->
 <?php if($sam_array['format']=='pdf'){?>
    ...
    <h2 style="text-align:center">STATEMENT OF ASSESSMENT METHODS - 2018 
...
<?php } else { ?>
<h2 style="text-align:center">STATEMENT OF ASSESSMENT METHODS - 2018  </h2>

<?php } ?>
</h2>
<p>Students' attention is drawn to the <em>Student Related Policies and Procedures</em> (available at: <a href="https://www.flinders.edu.au/policies" onclick="window.open(this.href);return false;">https://www.flinders.edu.au/policies</a>), and in particular the University's <i>Assessment Policy</i>. </p>
...
<?php }?>
  ...
  <p>College(s) responsible for topic: <strong>
...
https://www.flinders.edu.au/ppmanual/student/assessment-policy.cfm#AppendixB" target="_blank">https://www.flinders.edu.au/ppmanual/student/assessment
-policy.cfm#AppendixB</a>): <i>number of hours per week or in total.</i></p>
  <?php
...
<div id="topicAlignment" class="bordertop" style="page-break-before: avoid; page-break-inside: avoid">

<p tyle="page-break-after: avoid;"><strong>Alignment of Assessment with Expected Topic Learning Outcomes</strong></p>
 <?php  
...
<p>All students and staff have an obligation to understand and respect the rules and practice of academic integrity. It is therefore expected that students and staff will adhere to high standards of academic integrity (refer <a href="http://www.flinders.edu.au/ppmanual/student/academic-integrity.cfm" target="_blank">http://www.flinders.edu.au/ppmanual/student/academic-integrity.cfm</a>).</p>
...
<p>Staff use a range of methods (including electronic means) to assist in the detection of breaches of academic integrity. The University has mandated the use of text-matching for all text-based student assignments.  Except where the <i>Academic Integrity Policy</i> [<a href="http://www.flinders.edu.au/ppmanual/student/academic-integrity.cfm" target="_blank">http://www.flinders.edu.au/ppmanual/student/academic-integrity.cfm</a>] provides for an exemption under special circumstances, all text-based student assignments will be subject to text-matching in conjunction with their submission for assessment. </p>
<p>The University makes available for student use electronic text matching software, which can be accessed through the Flinders Learning Online Academic Integrity site [<a href="http://www.flinders.edu.au/academicintegrity/student.cfm" target="_blank">http://www.flinders.edu.au/academicintegrity/student.cfm</a>].</p>

<p>Have any exemptions from the requirement for the application of text-matching software to student assignments due to special circumstances been approved by the Dean (Education) for this topic? <strong>
...
<div id="resubmission" class="bordertop">
  ...
  <p><strong>Resubmission of Assessment Exercises</strong> [<a target="_blank" href="http://flex.flinders.edu.au/items/e950674b-2eb2-4bf2-a376-0a140ae13523/1/?.vi=file&attachment.uuid=14437745-2f65-4923-b0cb-ce27ee334688">link to clause 9.4 <i>Assessment Policy and Procedures</i></a>] <p>
...
<table style="width:100%; page-break-inside:avoid;" autosize="1">
    ...
    <tr>
    <td>
    <p style="line-height:0.6em; font-size:0.7em; margin-top:5px;" class="printonly">DVCA:   05.12.16</p>
    </td>
    <td>
    </td>
    </tr>
