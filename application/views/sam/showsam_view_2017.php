...
<!-- Content of SAM -->
 <?php if($sam_array['format']=='pdf'){?>
    ...
    <h2 style="text-align:center">STATEMENT OF ASSESSMENT METHODS - 2017
...
<?php } else{ ?>
<h2 style="text-align:center">STATEMENT OF ASSESSMENT METHODS - 2017 </h2>
<?php } ?>
</h2>
<p>Students' attention is drawn to the <em>Student Related Policies and Procedures</em> (available at: <a href="http://www.flinders.edu.au/ppmanual/student/student_home.cfm" onclick="window.open(this.href);return false;">http://www.flinders.edu.au/ppmanual/student/student_home.cfm</a>), and in particular the University's <i>Assessment Policy</i>. </p>
...
http://www.flinders.edu.au/ppmanual/student/assessment-policy.cfm#Appendixb" target="_blank">http://www.flinders.edu.au/ppmanual/student/assessment
