...
<table style="width:100%; page-break-inside:avoid;" autosize="1">
    ...
    <tr>
    	<td>
        	 <?php if($sam_array['metadata']['topics'][1]['topicSchool'] == 'School of Medicine'){
             	  $status = $sam_array['status'];
		  		   if(isset($status)){
					 echo ($status=='live')? '<p><br/><strong>&nbsp;&nbsp;&nbsp;Prof Kevin Forsyth</strong></p><br/>' : '<p><br/> </p><br/>'; 
		 		   }
              }
			  elseif($sam_array['metadata']['topics'][1]['topicSchool'] == 'School of Nursing & Midwifery'){
				  $status = $sam_array['status'];
		  		   if(isset($status)){
					 echo ($status=='live')? '<p><br/><strong>&nbsp;&nbsp;&nbsp;Kristen Graham</strong></p><br/>' : '<p><br/> </p><br/>'; 
		 		   }
			}
			 ?>
        </td>
    ...
    <tr>
    	<td>
			<p class="signature25">Signature of Course Coordinator</p>
			<p style="line-height:0.6em; font-size:0.7em" class="printonly">[Faculty of Medicine, Nursing and Health Sciences Only]</p>
        </td>
        <td>
			<p class="signature12">Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
			<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
