...
<div id="topic_specs" class="bordertop">
  <p>Topic number and title: <strong>
  <?php
  	$topic_code;
	$topic_name;
  ...
  <p>Units: <strong><?php echo (!isset($sam_array['metadata']['topics'][1]['topicUnits']) || ($sam_array['metadata']['topics'][1]['topicUnits']=='') )?$msg:$sam_array['metadata']['topics'][1]['topicUnits']; ?>
  </strong>
  <p>Date on which this statement was provided to students: <strong>
  <?php echo (!isset($sam_array['metadata']['approvalDate']) || ($sam_array['metadata']['approvalDate']=='') )? $draft_msg :date('j F Y',strtotime($sam_array['metadata']['approvalDate'])); 
		?>
        </strong></p>
  <p>Duration of topic: 
  <?php	
  ...
  <?php }
	 ...
	 echo  '<p>Topic Coordinator:'. $msg . '</p>';
  }
  ?>
...
<div id="workload" class="bordertop">
  ...
  <p><strong><?php echo (!isset($sam_array['metadata']['topics'][1]['work_load']))||($sam_array['metadata']['topics'][1]['work_load']=='')?$msg:$sam_array['metadata']['topics'][1]['work_load']; ?></strong></p>
...
<table style="width:100%; page-break-inside:avoid;" autosize="1">
    ...
    <tr>
    	<td>
        	 <?php if($sam_array['metadata']['topics'][1]['topicSchool'] == 'School of Medicine'){?> 
        	 <p> <br/> 
        	 <strong> Assoc Prof Mark Slee</strong></p>
             <br/> 
             <?php }?>
        </td>
        <td>
