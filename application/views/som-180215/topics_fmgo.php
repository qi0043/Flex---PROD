...
<div role="main">
  ...
  <div class="row">
<div id="myNav" class="span10"><a href="startup" class="btn btn-sm btn-primary">Return to dashboard</a>&nbsp;&nbsp;<a href="amcgo" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Tooltip on top">AMC Graduate Outcomes</a></div>

<h3>Course Overview - Flinders Medical Graduate Outcomes</h3>
...
<a href="/flex/som/fmgo/0" class="btn btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>

<div class="btn-group" style="margin-bottom:10px; float:left;">
<a href="/flex/som/fmgo/1" class="btn  btn-sm btn-default" >Level 1</a>
<a href="/flex/som/fmgo/2" class="btn btn-sm btn-default" >Level 2</a>
<a href="/flex/som/fmgo/3" class="btn btn-sm btn-default" >Level 3</a>
</div>



<a href="/flex/som/fmgo" class="btn active btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
...
<th colspan="3" valign="bottom" class="bg-danger" style="padding:5px;">Professionalism & Leadership</th>
    ...
    <tr>
      <th valign="bottom" style="padding:5px;" scope="col">Topic</th>
       <?php for ($i = 1; $i <= 8; $i++ ) { ?><th valign="bottom" style="padding:5px; width:9em;" scope="col"><a href="fmgosearch/<?php echo strtolower($topics[1]['course']['los']['lo'.$i]['code']);?>" class="standard"><?php echo $topics[1]['course']['los']['lo'.$i]['code'];?></a></th> <?php } ?>  
    </tr>
  </thead>
  <tbody>  
...
<img src="<?php echo base_url() . 'resource/som/';?>images/flextra-level-<?php echo $topic['course']['los']['lo'.$i]['level']; ?>.svg" alt="level<?php echo $topic['course']['los']['lo'.$i]['level']; ?>" width="18" height="18" title="Level <?php echo $topic['course']['los']['lo'.$i]['level']; ?>" data-toggle="tooltip" class="heatmap"><?php } else { ?>&nbsp;<?php } ?></td>
   <?php } ?>  
    </tr>
