...
?>
<img src="<?php echo base_url() . 'resource/som/';?>images/heat<?php echo $topic['prof']['los']['lo'.$i]['level']; ?>.png" alt="level<?php echo $topic['prof']['los']['lo'.$i]['level']; ?>" width="24" height="24" data-toggle="tooltip" data-placement="top" title="Level <?php echo $topic['prof']['los']['lo'.$i]['level']; ?>"><?php } else { ?>&nbsp;<?php } ?></td>
   <?php } ?>  
    </tr>
