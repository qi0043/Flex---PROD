...
<div role="main">
  ...
  <div class="row">
<div id="myNav"><a href="/flex/som/startup" class="btn btn-sm btn-primary">Return to dashboard</a>&nbsp;&nbsp;<a href="/flex/som/fmgo" class="btn btn-sm btn-success"> Flinders Medical Graduate Outcomes</a>&nbsp;&nbsp;<a href="/flex/som/amcgo" class="btn btn-sm btn-success">AMC Graduate Outcomes</a></div>
...
<tr>
<td align="left" valign="top" style="padding:5px; width:3em;" scope="col">      <a href="../topic/<?php echo $topic['uuid']; ?>/<?php echo $topic['version']; ?>" title="<?php echo $topic['title']; ?>" class="standard"><?php echo $topic['code']; ?></a></td>
  ...
  <?php if($topic['level'] != '' && $topic['level'] > 0) { ?><img src="<?php echo base_url() . 'resource/som/';?>images/flextra-level-<?php echo $topic['level']; ?>.svg" width="18" height="18"<?php if($topic['level'] > 0) { ?> data-toggle="tooltip" data-placement="top" title="Level <?php echo $topic['level']; ?>" class="heatmap" <?php } ?>><?php } ?>
