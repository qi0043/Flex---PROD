...
<input type="hidden" id="action_type" value="create_req"/>
  ...
  <div id="view_req_nav" class="row ">
      <div role="navigation"> 
        ...
        <div id="view_er_step2">
          <div class="col-md-2"> <a href="" class="btn btn-default disabled  btn-block" tabindex="100">2. <span class="hidden-md">Send request</span><span class="visible-md-inline">View requests</span></a> </div>
          <div class="col-md-1">
            <p class="text-center lead hidden-xs hidden-sm" > >> </p>
            <!--<p class="text-success lead hidden-xs hidden-sm" style="color:#5cb85c;"><span class="glyphicon glyphicon-ok"></span></p>--> 
          </div>
