...
function generateActivities($activityType, $itemUuid, $itemVersion, $activityName, $topicCode, $numLinkedActivities,$linked_activities, $index)
{
	...
	{?>
	  <li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?></span> &nbsp;&nbsp;<a href="/flex/som/lta2/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" target="_blank"><i>detail</i></a>
    <?php 
