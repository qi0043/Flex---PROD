...
<div class="jumbotron">
  ...
  <img src="<?php echo base_url() . 'resource/ocf/';?>images/logo-flinders_portrait.png" width="51" height="65" alt="Flinders University" style="float:left;">
...
<?php if ((in_array(strtolower($courseCode), $_SESSION['ocf_validgrouplist']))) { ?>        
        ...
        <div class="row equal">
          ...
          <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <!--Primary buttons with dropdown menu-->
                        <div class="btn-group">
                          <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" style="padding-left: 20px; padding-right: 20px; margin-bottom:10px;">Outcome reports&nbsp;&nbsp;<span class="caret"></span></button>
                            <ul class="dropdown-menu"> 
                            <?php foreach ($topics as $topic) { ?>
                                ...
                                <?php } ?>
                                       ...
                                       <!--Primary buttons with dropdown menu-->
                        <div class="btn-group">
                        <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" style="padding-left: 20px; padding-right: 20px; margin-bottom:10px;">Topic Summaries&nbsp;&nbsp;<span class="caret"></span></button>
                            <ul class="dropdown-menu"> 
                                <?php foreach ($topics as $topic) { ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Curriculum Map</h3>
                    </div>
                    <div class="panel-body">
                        <p><a class="btn btn-success" href="/flex/ocf/sMap/getStaticMap/<?php echo strtolower($courseCode); ?>">Prototype version</a> <b> &nbsp;&nbsp; MD staff</b></p>
                        <ul>
                            <?php /*?><?php 
