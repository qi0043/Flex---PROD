...
?>
<div id="myNav" class="span10"><a href="/flex/som/startup" class="btn btn-sm btn-primary">Return to dashboard</a>&nbsp;&nbsp;<a href="/flex/som/fmgo" class="btn btn-sm btn-success">Flinders Medical Graduate Outcomes</a></div>
<h3>Course Overview - AMC Graduate Outcomes - Level <?php echo $theLevel; ?></h3>
...
<a href="/flex/som/amcgo/0" class="btn <?php if ($theLevel == 0) { ?>active<?php } ?> btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>

<div class="btn-group" style="margin-bottom:10px; float:left;">
<a href="/flex/som/amcgo/1" class="btn <?php if ($theLevel == 1) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 1</a>
<a href="/flex/som/amcgo/2" class="btn <?php if ($theLevel == 2) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 2</a>
<a href="/flex/som/amcgo/3" class="btn <?php if ($theLevel == 3) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 3</a>
</div>



<a href="/flex/som/amcgo" class="btn btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
...
<div class="span10" id="theData">
  ...
  <thead>
    ...
    <tr>
      <th valign="bottom" style="padding:5px;" scope="col">&nbsp;</th>
      <?php for ($i = 1; $i <= 40; $i++ ) { ?>
      <th valign="bottom" style="padding:5px; width:4.2em;" scope="col"><a href="/flex/som/amcgosearch/<?php echo strtolower($topics[1]['prof']['los']['lo'.$i]['code']);?>" class="standard"><?php echo $topics[1]['prof']['los']['lo'.$i]['code'];?></a><?php if (strlen($topics[1]['prof']['los']['lo'.$i]['code']) < 4) { ?>&nbsp;<?php } ?></th>
 <?php } ?>  
    </tr>
 ...
 <?php foreach ($topics as $topic) { ?>
    <tr>
      ...
      <a href="/flex/som/topic/<?php echo $topic['uuid']; ?>/<?php echo $topic['version']; ?>" title="<?php echo $topic['title']; ?>" class="standard"><?php echo $topic['code']; ?></a>
      </td>
      <?php for ($i = 1; $i <= 40; $i++ ) { ?>
      <td align="center" style="padding:5px;" <?php if($topic['prof']['los']['lo'.$i]['numAlign'] > 0) { ?> class="notNullBG"<?php } ?>><?php if ($topic['prof']['los']['lo'.$i]['level'] == $topiccount['theLevel']) { ?>

<span class="notNullBG" style="padding:5px;"><img src="<?php echo base_url() . 'resource/som/';?>images/flextra-level-<?php echo $topic['prof']['los']['lo'.$i]['level']; ?>.svg" alt="level<?php echo $topic['prof']['los']['lo'.$i]['level']; ?>" width="18" height="18" data-toggle="tooltip" data-placement="top" title="Level <?php echo $topic['prof']['los']['lo'.$i]['level']; ?>"></span>
<?php } else { ?>
<span class="notNullBG" style="padding:5px;"><img src="<?php echo base_url() . 'resource/som/images/blank.gif'; ?>" alt="" width="18" height="18"></span><?php } ?></td>
   <?php } ?>  
    </tr>
