        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center" valign="top" style="padding:5px; width: 22em;" scope="col"><?php if ($topic['level'] == 0 && $topic['course']['lo']['numAlign'] > 0) { ?>
              ...
              <img src="/flex/resource/som/images/heat<?php echo $topic['level']; ?>.png" alt="" width="32" height="32" class="heatmap" title="Level <?php echo $topic['level']; ?>"<?php if($topic['level'] > 0) { ?> data-toggle="tooltip" data-placement="top" <?php } ?>>
              <?php } else { ?>
              &nbsp;
              <?php } ?></td>
