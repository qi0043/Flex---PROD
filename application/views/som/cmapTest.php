...
<div class="container-fluid">
 ...
 <div class="row">       
        <div id="myNav" class="col-md-12"><a href="/flex/som/startup" class="btn btn-sm btn-primary">Return to dashboard</a></div>
        </div>
										  ...
										  ?>
											<li class="topic_li">
                                                <span class="topic_span">
                                                 ...
                                                 <?php  
												 	 $refresh_id = 'rf_' . $topic['linked_activities'][1]['uuid'];
