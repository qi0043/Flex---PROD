	...
	if($index > 1)
	{
	 ...
	 if ($activityType == 'activity') { ?>
     	<?php switch($do_condition)
			{
				case "required":?>
                <li class="child_li"><i style="line-height:1em; vertical-align:middle" class="fa fa-exclamation-triangle fa-fw text-danger" title="required activity"></i> &nbsp;&nbsp;<a href="/flex/som/activity/<?php echo $itemUuid ?>/<?php echo $itemVersion; ?>/<?php echo $parent_uuid; ?>" data-toggle="modal" data-target="#myModal" title="View activity detail"><?php echo $activityName; ?></a></li>
		<?php		break;
				case "optional": ?>
                <li class="child_li"><i style="line-height:1em; vertical-align:middle" class="fa fa-dot-circle-o  fa-fw" title="optional activity"></i>&nbsp;&nbsp; <a href="/flex/som/activity/<?php echo $itemUuid ?>/<?php echo $itemVersion; ?>/<?php echo $parent_uuid; ?>" data-toggle="modal" data-target="#myModal" title="View activity detail"><?php echo $activityName; ?></a></li>
		<?php       break; 
				case "alternative": ?>
                <li class="child_li"><i style="line-height:1em; vertical-align:middle" class="fa fa-share-alt fa-fw" title="alternative activity"></i>&nbsp;&nbsp;<a href="/flex/som/activity/<?php echo $itemUuid ?>/<?php echo $itemVersion; ?>/<?php echo $parent_uuid; ?>" data-toggle="modal" data-target="#myModal" title="View activity detail"><?php echo $activityName; ?></a> </li>
        <?php       break; 
			}?>
	 <?php
	 	if($index > 1)
	 ...
	 elseif($activityType == 'group')
	 {
		switch($do_condition)
		{
			case "required":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?> &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-exclamation-triangle fa-fw text-danger" title="required activity"></i></span> &nbsp;&nbsp;<a href="/flex/som/lta2/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
				
				if($group_how_many == 1)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?>&nbsp;&nbsp; <i style="line-height:1em; vertical-align:middle" class="fa fa-exclamation-triangle fa-fw text-danger" title="required activity"></i> &nbsp;&nbsp;<i class="fa fa-list" title="This activity group has a choice of activities."></i><i class="fa fa-question" title="This activity group has a choice of activities"></i></span> &nbsp;&nbsp;<a href="/flex/som/lta2/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a> 
				<?php
				}
			break;
			case "optional":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?> &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-dot-circle-o  fa-fw" title="optional activity"></i></span> &nbsp;&nbsp;<a href="/flex/som/lta2/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
			...
			case "alternative":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?> &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-share-alt fa-fw" title="optional activity"></i></span> &nbsp;&nbsp;<a href="/flex/som/lta2/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
			...
			case "":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?></span> &nbsp;&nbsp;<a href="/flex/som/lta2/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
