...
<div class="span10">
<a href="/flex/ocf/topic/<?php echo $topics['itemID'];?>/1" class="btn btn-xs btn-default"><i class="fa fa-file-text-o"></i>&nbsp;View Topic Outcome Report</a>
<!--
...
<h4> Coordinator</h4>
<ul>
<?php foreach ($sam['sam']['coord'] as $coord) { ?>
...
<?php if ($activity['activityType'] == 'integrated') { ?>
<li><a href="/flex/ocf/lta/<?php echo $activity['itemUuid']; ?>/<?php echo $activity['itemVersion']; ?>/<?php echo $topics['tcode']; ?>" class="standard"><?php echo $activity['itemTitle']; ?></a></li>
<?php } else { ?>
<li><a href="/flex/ocf/activity/<?php echo $activity['itemUuid']; ?>/<?php echo $activity['itemVersion']; ?>/<?php echo $activity['itemUuid']; ?>" class="standard"><?php echo $activity['itemTitle']; ?></a></li>
<?php } ?>
<?php } // end activities ?>
</ul>
...
<ol>
<?php foreach ($sam['sam']['assessment'] as $assessment) { ?>
