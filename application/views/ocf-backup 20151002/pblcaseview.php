...
<link href="<?php echo base_url() . 'resource/ocf/';?>css/font-awesome-4.4.0/css/font-awesome.css" rel="stylesheet" type="text/css">


  <script src="<?php echo base_url() . 'resource/ocf/';?>js/foundation/foundation/foundation.js"></script>
  <script src="<?php echo base_url() . 'resource/ocf/';?>js/foundation/foundation/foundation.equalizer.js"></script>
 ...
 <?php if(isset($privilege))
	{
		...
		{
	?> 
<a href="<?php echo $flexserv; ?>/items/<?php echo $item['uuid']; ?>/<?php echo $item['version']; ?>?token=<?php echo $token; ?>" target="_blank" class="btn btn-sm btn-danger btn-block"><i class="fa fa-edit"></i> Edit case</a>
<?php 
		}}?>
...
<p>There are <?php echo $item['numberSections']; ?> tutorials for this case.</p>
</div>
...
<h4>Case View</h4>
<ul class="fa-ul">
  <li><i class="fa-li fa fa-television"></i><a href="javascript:show('<?php echo base_url() ;?>pbl/trigger/<?php echo $item['uuid'] ;?>/<?php echo $item['version'];?>','tutorial','scrollbars=yes,resizable=yes,width=1280,height=720');">Presentation format</a></li>
  <li><i class="fa-li fa fa-print"></i>Print format
    <ul class="fa-ul">
      ...
      <li style="margin-left:-7px;"><i class="fa-li fa fa-file-o"></i><a href="<?php echo base_url() ;?>pbl/tutor/<?php echo $item['uuid'] ;?>/<?php echo $item['version'];?>" target="_blank">Tutor notes</a></li>
    </ul>
  </li>
  </ul>
</div>
...
<h4>Case Resources</h4>
  ...
  <?php foreach ($caseresources as $cr) { ?>
    <div class="col-md-2 col-sm-4 col-xs-6" style="font-size:0.9em;"  data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $cr['title']; ?>">
       <a href="<?php echo $cr['view']; ?>&token=<?php echo $token;?>" class="thumbnail" target="_blank"  data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $cr['title']; ?>">
