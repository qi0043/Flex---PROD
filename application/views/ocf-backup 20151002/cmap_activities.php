	 ...
	 elseif($activityType == 'group')
	 {
		switch($do_condition)
		{
			...
			case "optional":
				...
				if($group_how_many == 1)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <i style="line-height:1em; vertical-align:middle" class="fa fa-circle-o  fa-fw text-primary" title="optional activity"></i>&nbsp;&nbsp;<?php echo $activityName; ?> &nbsp;&nbsp;<i class="fa fa-list text-primary" title="This activity group has a choice of activities."></i><i class="fa fa-question text-primary" title="This activity group has a choice of activities"></i></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a> 
				<?php
				}
				break;
			case "alternative":
