...
<div class="container-fluid" style="margin:0 20px 0 20px;">
  <div role="main">
     ...
     <li><a href="/flex/ocf/activity/<?php echo $linked['itemUuid']; ?>/<?php echo $activity['itemVersion']; ?>/<?php echo $linked['itemUuid']; ?>" target="_blank" title="View activity detail"><?php echo $linked['title']; ?></a></li>
     <?php } else { ?>
     <li><span><i class="fa fa-plus-circle"></i> <?php echo $linked['title']; ?></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/<?php echo $linked['itemUuid']; ?>/<?php echo $linked['itemVersion']; ?>/<?php echo $topic['code']; ?>" target="_blank">view detail</a><?php } ?>

     <?php if (isset($linked['numLinkedActivities']) && ($linked['numLinkedActivities'] > 0)) { ?>
     <ul><?php } ?>
     <?php foreach($linked['linked_activities'] as $activity) { ?>
      <li><a href="/flex/ocf/activity/<?php echo $activity['itemUuid']; ?>/<?php echo $activity['itemVersion']; ?>/<?php echo $linked['itemUuid']; ?>" target="_blank" title="View activity detail"><?php echo $activity['title']; ?></a>
      <?php } ?>
     <?php if (isset($linked['numLinkedActivities']) && ($linked['numLinkedActivities'] > 0))  { ?>
     </ul><?php } ?>
     </li>
