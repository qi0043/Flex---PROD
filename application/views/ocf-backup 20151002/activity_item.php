...
<div class="row" style="margin-bottom:0.5em;" id="itemdescription">
 ...
 <?php if(isset($privilege))
	{
		...
		{
	?> 
 <a href="/flex/ocf/editname/<?php echo $item['thisUuid']; ?>/<?php echo $item['thisVersion']; ?>" id="changeName" class="btn btn-sm btn-warning btn-block"><i class="fa fa-edit"></i> Change name</a>
 
 
<a href="<?php echo $flexserv; ?>/items/<?php echo $item['thisUuid']; ?>/<?php echo $item['thisVersion']; ?>?token=<?php echo $token; ?>" target="_blank" class="btn btn-sm btn-danger btn-block"><i class="fa fa-edit"></i> Edit</a>
<?php 
		}}?>
...
<!--   <div class="panel-heading ">
   ...
   <p><span style="margin-right: 2em;"><strong>Resources</strong></span></p>
    ...
    <li><?php echo $resourceclass; ?><a href="<?php echo $resourceserver; ?>/<?php echo $linktype; ?><?php echo $linkuse ; ?>?token=<?php echo $token; ?>" target="_blank"><?php if($item['pblCase'] != "False") { ?>Case page:&nbsp;<?php } ?><?php echo $olinked['description']; ?></a></li>
      <?php } ?>
    <?php } ?>
    </ul>
    <?php } ?>
