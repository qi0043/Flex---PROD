...
<a href="/flex/ocf/<?php echo $courses['code'] ?>/amcgo/0" class="btn  btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>
...
<a href="/flex/ocf/<?php echo $courses['code']; ?>/amcgo" class="btn active btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
