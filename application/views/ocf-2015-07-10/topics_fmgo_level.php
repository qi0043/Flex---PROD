...
<a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo/0" class="btn <?php if ($theLevel == 0) { ?>active<?php } ?> btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>
<div class="btn-group" style="margin-bottom:10px; float:left;">
<a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo/1" class="btn <?php if ($theLevel == 1) { ?>active<?php } ?> 
...
<a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo" class="btn btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
 <div class="span10">
