...
<h3>Course Overview - <?php echo $coursestringlong; ?></h3>
...
<a href="/flex/ocf/<?php echo $courses['code'] ?>/fmgo/0" class="btn btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>

<div class="btn-group" style="margin-bottom:10px; float:left;">
<a href="/flex/ocf/<?php echo $courses['code'] ?>/fmgo/1" class="btn  btn-sm btn-default" >Level 1</a>
<a href="/flex/ocf/<?php echo $courses['code'] ?>/fmgo/2" class="btn btn-sm btn-default" >Level 2</a>
<a href="/flex/ocf/<?php echo $courses['code'] ?>/fmgo/3" class="btn btn-sm btn-default" >Level 3</a>
</div>



<a href="/flex/ocf/<?php echo $courses['code'] ?>/fmgo" class="btn active btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
