    ...
    <nav class="navbar">
        <div class="container">
            <div class="navbar-header col-xs-9 col-md-10">
                <a class="brand" href="https://flextra-test.flinders.edu.au/flex/rhd/newItem/index">Flinders University Theses</a>
            </div>
            <div class="navbar-header col-xs-3 col-md-2">
                <ul class="nav">
                     <li class="brand"><i class="glyphicon glyphicon-user"></i> <span class="right"><?php if(isset($_SESSION['fan'])){echo $_SESSION['fan'];} else {echo 'You are not logged in';}?></span></li>
                </ul>
            </div>
