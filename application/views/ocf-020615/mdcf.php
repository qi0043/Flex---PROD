...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <ul>
    <li><a href="/flex/ocf/fmgo">Flinders Medical Graduate Outcomes (FMGO)</a></li>
    <li><a href="/flex/ocf/amcgo">AMC Graduate Outcomes (AMCGO)</a></li>
  </ul>
  </div>
</div>
</div> 
 ...
 <!--Primary buttons with dropdown menu-->
        <div class="btn-group">
            ...
            <?php foreach ($topics as $topic) { ?>
                <li><a href="/flex/ocf/topic/<?php echo $topic['uuid']; ?>/<?php echo $topic['version']; ?>"><?php echo $topic['code']; ?> :: <?php echo $topic['title']; ?></a></li>
                <?php } ?>
            </ul>
        </div>
  </div>
...
<div class="panel panel-default">
 ...
 <!--Primary buttons with dropdown menu-->
        <div class="btn-group">
            ...
            <?php foreach ($topics as $topic) { ?>
                <li><a href="/flex/ocf/summary/<?php echo $topic['uuid']; ?>/<?php echo $topic['version']; ?>"><?php echo $topic['code']; ?> :: <?php echo $topic['title']; ?></a></li>
                <?php } ?>
            </ul>
        </div>
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <ul>
    <li><a href="/flex/ocf/cmap">Map v0.1</a></li>
    <li><a href="/flex/ocf/maptest">Map v0.2</a> <b> &nbsp;&nbsp; Demo Version </b></li>
  </ul>
  </div>
</div>
</div>
