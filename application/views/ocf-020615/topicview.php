...
<div class="span10">
<a href="/flex/ocf/summary/<?php echo $topics['itemID'];?>/1" class="btn btn-xs btn-default"><i class="fa fa-file-text-o"></i>&nbsp;View Topic Summary</a>
<!--
...
<a href="/flex/ocf/fmgosearch/<?php echo strtolower($courseoutcome['code']);?>" class="btn btn-link instruction standard" style="padding:0;"  data-toggle="tooltip" data-placement="top" data-html="true" title="View report for this<br />Learning Outcome" ><?php echo $courseoutcome['catcode']; ?> - <?php echo $courseoutcome['code']; ?></a><!--<span style="margin-left: 1.5em;" class="instruction"  data-toggle="tooltip" data-placement="top" data-html="true" title="Click to view Learning Outcome statement" ><a class="btn btn-link doNotPrint" style="padding:0;"   data-toggle="modal" href="<?php echo base_url() . 'resource/ocf/';?>html/fmgo/<?php echo strtolower($courseoutcome['code']); ?>.html" data-target="#myModal" ><i class="fa fa-info-circle"></i></a></span>--><br />
...
<a href="/flex/ocf/amcgosearch/<?php echo strtolower($profoutcome['code']);?>" class="btn btn-link instruction standard" style="padding:0;"  data-toggle="tooltip" data-placement="top" data-html="true" title="View report for this<br />Learning Outcome" >
