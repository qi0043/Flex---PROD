...
<a href="/flex/ocf/fmgo/0" class="btn btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>

<div class="btn-group" style="margin-bottom:10px; float:left;">
<a href="/flex/ocf/fmgo/1" class="btn  btn-sm btn-default" >Level 1</a>
<a href="/flex/ocf/fmgo/2" class="btn btn-sm btn-default" >Level 2</a>
<a href="/flex/ocf/fmgo/3" class="btn btn-sm btn-default" >Level 3</a>
</div>



<a href="/flex/ocf/fmgo" class="btn active btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
...
<img src="<?php echo base_url() . 'resource/ocf/';?>images/flextra-level-<?php echo $topic['course']['los']['lo'.$i]['level']; ?>.svg" alt="level<?php echo $topic['course']['los']['lo'.$i]['level']; ?>" width="18" height="18" title="Level <?php echo $topic['course']['los']['lo'.$i]['level']; ?>" data-toggle="tooltip" class="heatmap"><?php } else { ?>&nbsp;<?php } ?></td>
   <?php } ?>  
    </tr>
