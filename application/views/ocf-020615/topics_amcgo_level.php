...
?>
<div id="myNav" class="span10"><a href="/flex/ocf/startup" class="btn btn-sm btn-primary">Return to dashboard</a>&nbsp;&nbsp;<a href="/flex/ocf/fmgo" class="btn btn-sm btn-success">Flinders Medical Graduate Outcomes</a></div>
...
<a href="/flex/ocf/amcgo/0" class="btn <?php if ($theLevel == 0) { ?>active<?php } ?> btn-sm btn-default" style="margin-right:25px; float:left;">Show None</a>

<div class="btn-group" style="margin-bottom:10px; float:left;">
<a href="/flex/ocf/amcgo/1" class="btn <?php if ($theLevel == 1) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 1</a>
<a href="/flex/ocf/amcgo/2" class="btn <?php if ($theLevel == 2) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 2</a>
<a href="/flex/ocf/amcgo/3" class="btn <?php if ($theLevel == 3) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 3</a>
</div>



<a href="/flex/ocf/amcgo" class="btn btn-sm btn-default" style="margin-left:25px;">Show All</a>
<br clear="left" />
...
<div class="span10" id="theData">
  ...
  <thead>
    ...
    <tr>
      <th valign="bottom" style="padding:5px;" scope="col">&nbsp;</th>
      <?php for ($i = 1; $i <= 40; $i++ ) { ?>
      <th valign="bottom" style="padding:5px; width:4.2em;" scope="col"><a href="/flex/ocf/amcgosearch/<?php echo strtolower($topics[1]['prof']['los']['lo'.$i]['code']);?>" class="standard"><?php echo $topics[1]['prof']['los']['lo'.$i]['code'];?></a><?php if (strlen($topics[1]['prof']['los']['lo'.$i]['code']) < 4) { ?>&nbsp;<?php } ?></th>
 <?php } ?>  
    </tr>
...
<span class="notNullBG" style="padding:5px;"><img src="<?php echo base_url() . 'resource/ocf/';?>images/flextra-level-<?php echo $topic['prof']['los']['lo'.$i]['level']; ?>.svg" alt="level<?php echo $topic['prof']['los']['lo'.$i]['level']; ?>" width="18" height="18" data-toggle="tooltip" data-placement="top" title="Level <?php echo $topic['prof']['los']['lo'.$i]['level']; ?>"></span>
<?php } else { ?>
