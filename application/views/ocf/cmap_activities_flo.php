	 ...
	 elseif($activityType == 'group')
	 {
		switch($do_condition)
		{
			...
			case "optional":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?> &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-dot-circle-o  fa-fw" title="optional activity"></i></span> &nbsp;&nbsp;<a href="/flex/flo-ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
			...
			case "alternative":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?> &nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-share-alt fa-fw" title="optional activity"></i></span> &nbsp;&nbsp;<a href="/flex/flo-ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
			...
			case "":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?></span> &nbsp;&nbsp;<a href="/flex/flo-ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
