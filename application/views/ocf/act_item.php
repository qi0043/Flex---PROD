...
<div class="col-md-12">
  <div class="panel panel-primary">
	...
	default:
	  ...
	  ?>
        <li><?php echo $resourceclass; ?><a href="http://flex.flinders.edu.au/items/<?php echo $item['thisUuid']; ?>/<?php echo $item['thisVersion']; ?>/<?php echo $a['filename']; ?>?token=<?php echo $token; ?>" target="_blank"><?php echo $a['title']; ?></a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
