...
<script type="text/javascript" src="<?php echo base_url() . 'resource/flo/ocf/';?>js/cmap.js"></script>   
  ...
  <div class="container-fluid">
    <div class="col-md-9 col-sm-12 col-xs-12"> <img src="<?php echo base_url() . 'resource/flo/ocf/';?>images/logo-flinders_portrait.png" width="51" height="65" alt="Flinders University" style="float:left;" />
      <div class="banner-text">
        <h2>Browse Course Activities <small style="color:#1C1C1C">(DYNAMIC MAP: OCF team only)</small></h2>
...
<div class="container-fluid" style="margin:15px 20px 0 20px;">
	...
	<div role="main">
      ...
      <div class="alert alert-success small" role="alert">
            ...
            <p><strong>For use by OCF team only</strong></p>
			<ul style="margin-bottom:3px;">
            	<li>New activities can be displayed in this map.</li>
    ...
    <div class="panel panel-primary affix" style="margin-right:25px;">
      ...
      <div class="panel-body">
        ...
        <dl class="dl-horizontal">
          <!--<dt style="margin-top:10px;"><i class="fa fa-list fa-lg text-primary"></i><i style="line-height:1em; vertical-align:middle" class="fa fa-question fa-lg text-primary "></i> </dt>
          <dd style="margin-top:10px;">This indicates the activity group has a choice of activities.</dd>-->
          ...
          <dt><small class="alert alert-warning" style="padding: 0 0; font-size:12px"> <strong>&nbsp;N</strong><span class="badge" style="background-color:transparent; border:hidden; color:#8a6d3b;"><i class="fa fa-lock"></i></span></small></dt>
          <dd>Activity name locked</dd>
          <dt><small class="alert alert-success" style="padding: 0 0; font-size:12px"> <strong>&nbsp;O</strong><span class="badge" style="background-color:transparent; border:hidden; color:#8a6d3b;"><i class="fa fa-lock"></i></span></small></dt>
          <dd>Activity overview locked</dd>
          <dt><small class="alert alert-info" style="padding: 0 0; font-size:12px"> <strong>&nbsp;A</strong><span class="badge" style="background-color:transparent; border:hidden; color:#8a6d3b;"><i class="fa fa-lock"></i></span></small></dt>
          <dd>Activity locked</dd>
        </dl>
      </div>
    </div>
  </div>
