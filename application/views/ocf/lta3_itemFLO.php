...
<?php echo $docondition; ?><a href = "/flex/flo-ocf/activityflo/<?php echo $activity['itemUuid']; ?>/<?php echo $activity['itemVersion']; ?>/<?php echo $activity['activityParent']; ?>"  class="ajaxLoad" title="View activity detail"><?php echo $activity['title']; ?></a>
<?php } ?>

<?php if ($linktype == "group" ) { ?>
<?php echo $docondition; ?><a href = "/flex/flo-ocf/ltats/<?php echo $activity['itemUuid']; ?>/<?php echo $activity['itemVersion']; ?>/<?php echo $item['itemTopic']; ?>"  title="View activity group"><?php echo $activity['title']; ?></a>
<?php } ?>
</li>
...
<h4> Learning  Objectives & Alignment<button id="loControl" class="btn btn-mini btn-default" style="margin-left:3em;" data-toggle="collapse" data-target="#collpaseLO" aria-expanded="true" aria-controls="collpaseLO">Show/Hide
</button></h4>
