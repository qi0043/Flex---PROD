...
function generateActivities($parent_uuid, $activityType, $itemUuid, $itemVersion, $activityName, $topicCode, $numLinkedActivities,$linked_activities,$group_how_many, $do_condition, $index)
{
	...
	if($index > 1)
	{
	 ...
	 if ($activityType == 'activity') { ?>
		...
		<?php		break;
				case "optional": ?>
                <li class="child_li"><i style="line-height:1em; vertical-align:middle" class="fa fa-circle-o  fa-fw" title="optional activity"></i>&nbsp;&nbsp; <a href="/flex/ocf/activity/<?php echo $itemUuid ?>/<?php echo $itemVersion; ?>/<?php echo $parent_uuid; ?>" data-toggle="modal" data-target="#myModal" title="View activity detail"><?php echo $activityName; ?></a></li>
		<?php       break; 
				case "alternative": ?>
	 ...
	 elseif($activityType == 'group')
	 {
		switch($do_condition)
		{
			case "required":
				...
				if($group_how_many >= 1)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?>&nbsp;&nbsp;<small class="badge">pick&nbsp; <?php echo $group_how_many ?>&nbsp;of&hellip;</small></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a> 
				<?php
				}
			break;
			case "optional":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <i style="line-height:1em; vertical-align:middle" class="fa fa-circle-o  fa-fw text-primary" title="optional activity"></i>&nbsp;&nbsp;<?php echo $activityName; ?> </span> &nbsp;&nbsp;<a href="/flex/ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
				...
				{?>
					<li class="parent_li">
                    	<span>
                         ...
                         <a href="/flex/ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php
				}
				break;
			case "alternative":
				if($group_how_many == 0)
				{?>
					<li class="parent_li"><span><i class="fa fa-plus-circle"></i> <?php echo $activityName; ?> <!--&nbsp;&nbsp;<i style="line-height:1em; vertical-align:middle" class="fa fa-share-alt fa-fw text-primary" title="alternative activity"></i>--></span> &nbsp;&nbsp;<a href="/flex/ocf/lta/<?php echo $itemUuid; ?>/<?php echo $itemVersion; ?>/<?php echo $topicCode; ?>" data-toggle="modal" data-target="#myModal"><i>detail</i></a>
				<?php 
				}
