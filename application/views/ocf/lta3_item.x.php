...
<p><?php echo $item['itemDescription']; ?></p>
 ...
 <a href="/flex/ocf/editdescription/<?php echo $item['thisUuid']; ?>/<?php echo $item['thisVersion']; ?>" id="editDescription" class="btn btn-sm btn-success btn-block"><i class="fa fa-edit"></i> Edit description</a>
 
 
<a id="editItem" href="<?php echo $flexserv; ?>/items/<?php echo $item['thisUuid']; ?>/<?php echo $item['thisVersion']; ?>?token=<?php echo $token; ?>" target="_blank" class="btn btn-sm btn-danger btn-block"><i class="fa fa-edit"></i> Edit</a>
<?php 
		}}?>
