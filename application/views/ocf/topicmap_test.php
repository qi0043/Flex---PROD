...
$(window).load(function() {
	$('.spinner-wave').fadeOut(1500, function() {
...
<div class="container-fluid" style="margin:0 20px 0 20px;">
	<div role="main">
        ...
        <?php /*?><div id="loading" style="z-index:100;">
        	<center>
			<img style="z-index:100;" id="loading-image" src="<?php echo base_url() . 'resource/coord/';?>images/loading.gif" alt="Loading..." />
            </center>
		</div><?php */?>
