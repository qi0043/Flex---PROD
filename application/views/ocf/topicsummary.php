...
<a href="/flex/ocf/<?php echo strtolower($topics['courseCode']); ?>/mapsummary/<?php echo $topics['itemID'];?>/1" class="btn btn-xs btn-default"><i class="fa fa-file-text-o"></i>&nbsp;View Topic Summary</a>
<?php } ?>
