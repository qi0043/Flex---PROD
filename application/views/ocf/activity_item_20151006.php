...
<?php } ?>
    ...
    <li><?php echo $resourceclass; ?><a href="<?php echo $resourceserver; ?>/<?php echo $linktype; ?><?php echo $linkuse ; ?>" target="_blank" <?php echo $linkclass; ?>><?php if($item['pblCase'] != "False") { ?>Case page:&nbsp;<?php } ?><?php echo $olinked['description']; ?></a></li>
      <?php } ?>
    <?php } ?>
    </ul>
    </div>
