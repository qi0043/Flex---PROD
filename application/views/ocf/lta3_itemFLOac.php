...
<div class="jumbotron">
  <div class="container-fluid">
    ...
    <!--             -->
    <img src="https://cal4.flinders.edu.au/flextra/flinders_logo.png"  alt="Flinders University" width="151" height="65" style="float:left;">
...
<h5> Learning  Objectives & Alignment<button id="loControl" class="btn btn-mini btn-default doNotPrint" style="margin-left:3em;" data-toggle="collapse" data-target="#collpaseLO" aria-expanded="true" aria-controls="collpaseLO">Show/Hide</button><button id="printControl" class="btn btn-mini btn-default doNotPrint" style="margin-left:1em;" ><i class="fa fa-print"></i>&nbsp;Print</button></h5>

<div class="collapse in" id="collpaseLO">
