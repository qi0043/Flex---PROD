...
$(document).ready(function() {
  ...
  $('#updatethis').click(function() {
    ...
    <form>
      ...
      <input name="itemname" type="text" class="form-control" id="itemname" value="<?php echo $item['itemTitle']; ?>" />
      <span class="input-group-btn">
      <button type="button" class="btn btn-success" id="updatethis"><i class="fa fa-check-square-o"></i>&nbsp;Save</button>
      </span>
