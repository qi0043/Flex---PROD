 ...
 <?php if(isset($privilege))
	{
		...
		{
			// https://flextra-test.flinders.edu.au/flex/flo/ocf/generatetoken/editactivity/items/a18fa70d-bb27-4ae1-88d3-a0efbc593bdc/1
			
	?> 
<a href="/flex/ocf/generatetoken/editactivity/items/<?php echo $item['uuid']; ?>/<?php echo $item['version']; ?>" target="_blank" class="btn btn-sm btn-danger btn-block"><i class="fa fa-edit"></i> Edit case</a>
<?php 
		}}?>
...
<h4>Case Resources</h4>
  ...
  <?php foreach ($caseresources as $cr) { ?>
    <div class="col-md-2 col-sm-4 col-xs-6" style="font-size:0.9em;"  data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $cr['title']; ?>">
       <a href="/flex/ocf/generatetoken/viewitem/items/<?php echo $item['uuid']; ?>/<?php echo $item['version']; ?>/<?php echo $cr['uuid']; ?>" class="thumbnail" style="height:120px; overflow:hidden;" target="_blank"  data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $cr['title']; ?>">
