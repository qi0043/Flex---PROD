...
<div class="container-fluid" style="margin:0 20px 0 20px;">
  ...
  <div role="main">
    ...
    <a href="/flex/ocf/summary/<?php echo $sam_array['topic_info_uuid'];?>/<?php echo $sam_array['topic_info_version'];?>" class="btn btn-xs btn-default" target="_blank"><i class="fa fa-file-text-o"></i>&nbsp;View Topic Summary</a>
    <?php }?>
...
<thead>
   ...
   <?php /*?> <th align="left" valign="top" style="padding:5px;" scope="col">Aligned Course Outcomes</th><?php */?>
