...
-->
  ...
  <div class="btn-toolbar" role="toolbar">
    <div class="btn-group" role="group" style="margin-bottom:10px; float:left;"> <a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo/0" class="btn <?php if ($theLevel == 0) { ?>active<?php } ?> btn-sm btn-default" style="float:left;">Show None</a></div>
    <div class="btn-group" role="group" style="margin-bottom:10px; float:left;"> <a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo/1" class="btn <?php if ($theLevel == 1) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 1</a>
<a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo/2" class="btn <?php if ($theLevel == 2) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 2</a>
<a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo/3" class="btn <?php if ($theLevel == 3) { ?>active<?php } ?> 
 btn-sm btn-default" >Level 3</a></div>
    <div class="btn-group" role="group" style="margin-bottom:10px; float:left;"> <a href="/flex/ocf/<?php echo $courses['code']; ?>/fmgo" class="btn btn-sm btn-default" >Show All</a> </div>
  </div>
...
<th valign="bottom" style="padding:5px;"></th>
    ...
    <tr>
      <th valign="bottom" style="padding:5px;" scope="col">Topic</th>
       ...
       <th valign="bottom" style="padding:5px; width:9em;" scope="col"><a href="/flex/ocf/fmgosearch/<?php echo strtolower($topics[1]['course']['los']['lo'.$i]['code']);?>"><?php echo $topics[1]['course']['los']['lo'.$i]['code'];?></a></th> <?php } ?>  
    </tr>
  </thead>
  <tbody>  
