...
<div role="tabpanel">
  ...
  <?php foreach($profdomain as $domain) { ?>
    ...
    <li role="presentation" class="text-<?php echo $domain['class']; ?>"><a href="#<?php echo $domain['code']; ?>" aria-controls="<?php echo $domain['code']; ?>" role="tab" data-toggle="tab">Domain: <?php echo $domain['name']; ?></a></li>
