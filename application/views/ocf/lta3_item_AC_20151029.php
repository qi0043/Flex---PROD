...
?>
	      ...
	      <?php echo $docondition; ?><?php echo $activity['itemName']; ?>
              <?php if(isset($privilege) && $privilege == 'moderator&contributor'){ ?>
	      &nbsp;<div style="float:right;"><a onclick="delete_activity_fn('<?php echo $activity['itemUuid'];?>', '<?php echo $activity['itemVersion'];?>');" href="#" title="Remove" ><span class="glyphicon glyphicon-remove-sign"></span></a></div><div style="clear:right;"></div>
	      <?php }?>
            </td>
