...
<div role="main">
  ...
  <h4><?php echo $coursestringsingle; ?> :: <?php echo $topics[1]['catName']; ?> - <?php echo $topics[1]['locode']; ?></h4>
...
<td align="left" valign="top" style="padding:5px; width:3em;" scope="col">      <a href="../topic/<?php echo $topic['uuid']; ?>/<?php echo $topic['version']; ?>" title="<?php echo $topic['title']; ?>"><?php echo $topic['code']; ?></a></td>
  ...
  <?php if($topic['level'] != '' && $topic['level'] > 0) { ?><img src="<?php echo base_url() . 'resource/flo/ocf/';?>images/flextra-level-<?php echo $topic['level']; ?>.svg" width="18" height="18"<?php if($topic['level'] > 0) { ?> data-toggle="tooltip" data-placement="top" title="Level <?php echo $topic['level']; ?>" class="heatmap" <?php } ?>><?php } ?>
