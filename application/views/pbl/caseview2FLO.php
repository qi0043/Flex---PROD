...
<!-- Latest xl and xxl css -->
<link rel="stylesheet" href="<?php echo base_url() . 'resource/flo/ocf/';?>css/bootstrap-xl-xxl.css">
...
<?php if (!empty($caseresources)) { ?>
  ...
  <?php foreach ($caseresources as $cr) { ?>
    <div class="col-xxl-1 col-xl-2 col-lg-2 col-md-2 col-sm-3 col-xs-6" style="font-size:12px;">
       <a href="/flex/flo-ocf/generatetoken/viewitem/items/<?php echo $case['uuid']; ?>/<?php echo $case['version']; ?>/<?php echo $cr['uuid']; ?>" class="thumbnail" style="height:140px; overflow:hidden;" target="_blank">
...
<div id="screencontent" style="margin-top:65px;">
...
if (strlen($caseTitle) > 50 ) {
	
	
	$theTitle = substr($caseTitle, 0, 25) . "...";
...
?>
<p style="font-size:10px; font-style:italic; float:right;">PBL Case: <?php echo $theTitle; ?> :: Tutorial <?php echo $screen['tutorial']; ?>, Screen <?php if ($screen['screenNumber'] < 10) { ?>0<?php } ?><?php echo $screen['screenNumber']; ?> </p>
