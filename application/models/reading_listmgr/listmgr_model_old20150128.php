...
class Listmgr_model extends CI_Model {
    ...
    {
        $sql_chk_reading = "
        select i.flex_code, i.rollover_from, f.reading_description, f.reading_link, f.reading_citation, f.reading_notes, f.internal_notes
    ...
    */
    ...
    function db_chk_topic_coord($fan)
    {
        $sql_get_topic_coord = "SELECT * 
                            ...
                            WHERE  fan = ? AND deleted_flo = false";
