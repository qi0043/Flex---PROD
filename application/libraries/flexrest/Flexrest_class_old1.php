...
class Flexrest_class extends oauth_client_class
{
    protected $ci;
     ...
     * @return boolean
     */
    protected function post($url, $data, &$response)
    {
        
        return($this->restCall($url, 'POST', $data, array('RequestContentType'=>'application/json'), $response));
    }
     ...
     * @return boolean
     */
    protected function put($url, $data, &$response)
    {
        
        return($this->restCall($url, 'PUT', $data, array('RequestContentType'=>'application/json'), $response));
    }    
